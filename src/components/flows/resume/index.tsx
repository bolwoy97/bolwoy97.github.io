    ...
    <>
      <div className="main-content">
        ...
        <section>
          <h3>About Me:</h3>
          <p>
            I am a Node-React developer with 3+ years of experience in building
            scalable and high-performance applications. I am seeking a
            challenging position in a dynamic project where I can leverage my
            skills to design and develop innovative solutions that solve complex
            business problems.
          </p>
        </section>
        <section>
          ...
          <div className="experience">
            ...
            <ul className="responsibilities">
              <li>
                Contributed to the development of a Node.js and React.js -based
                platform for Administering the big healthcare system
              </li>
              <li>
                Worked closely with designers and project managers to ensure
              ...
              <li>
                Doing configuration management, CI, updating Node/packages to
                higher versions
              </li>
              <li>
              ...
              <li>
                Debugged and tested code to ensure functionality and performance
              </li>
              <li>Working with Cloud (AWS, Azure)</li>
              <li>
                Was assisting DevOPS team in app containerization and Nginx
                management
              </li>
              <li>
              ...
              <li>
                Has experience being a presenter for the beginner frontend
                marathon.
              </li>
            </ul>
          </div>
          <div className="experience">
            ...
            <ul className="responsibilities">
              <li>
                Developed and maintained several Node.js based web applications
              </li>
              <li>
                Designed and developed RESTful APIs and implemented Swagger for
                API documentation
              </li>
              <li>
          ...
          <div className="experience">
            <h4>
              <p> Aug 2017- Nov 2020: Web Developer, seasonal</p>
              <p className="technologies"> (CodeIgniter, raw PHP, Vue js).</p>
            </h4>
            <ul className="responsibilities">
      ...
      <div className="sidebar">
        ...
        <div className="links">
          ...
          <ul>
            <li>
              <a href="https://www.linkedin.com/in/leonid-shadrin-999346155">
                LinkedIn
              </a>
            </li>
            <li>
              <a href="https://djinni.co/q/9e97853a55/">Djinni</a>
            </li>
          </ul>
        </div>
      </div>
